# Manifiesto de fuentes canónicas para ChatGPT

Document-Role: PROJECT_SOURCE_MANIFEST
...
1. Autorización explícita vigente de Jonathan Martínez para la acción concreta.
...
1. `02_GOVERNANCE_AUTHORITY_AND_TRUTH.md`
2. `03_STARTUP_AND_CANONICAL_SOURCES.md`
3. `04_EXECUTION_EFFICIENCY_AND_BRIEFS.md`
