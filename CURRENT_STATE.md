...
## Estado efectivo posterior a M2 y reconciliación 156

El contenido anterior se conserva byte por byte como vista histórica del parent `9e5dc65cd076e4bd65e6cfd61f8fb44ecb42e8bb`. No representa por sí solo el estado efectivo posterior.

- M2 técnico: `PASS`.
- Shadow registry: `SHADOW_ONLY_NOT_ACTIVE`.
- Selector activo: sin cambios, blob `301ba432907758fc49a9b3c86a83fc762eac4607`.
- Digest M2 reproducible: `e1a881640a544e483a1e47d52d72782b966ffc1e32cf6ff6c3afa03d54df6359`.
- Autorización 155: `CONSUMED` e inmutable.
- Autorización 156: reconciliación documental consumida.
- Alcance completo aprobado de 155: preservado en suplemento aditivo.
- Brief M2 completo: restaurado mediante revisión 2, sin nueva autoridad de ejecución.
- Variación de ejecutor M2: `UNAUTHORIZED_EXECUTOR_VARIANCE`, registrada sin autorización retroactiva.
- `PEND-LAB-034`: `AWAITING_SEPARATE_HUMAN_DECISION`; bloquea la entrada a M3.
